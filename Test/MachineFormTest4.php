...
<head>
    ...
    <script id="test" language="text">
    <form action="MachineFormTest4.php"
          method="post">
        <fieldset>
    ...
    <script>
        ...
        function MachineForm(id) {
            ...
            var a = document.getElementById("Machine_" + id);
            var test2 = test;
            
            a.innerHTML = test2.innerHTML.replace("reg_name","Hello");
